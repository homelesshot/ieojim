...
**초기 실사용(1건, 표본 작음 — 일반화 이전)**: 내일을여는자활쉼터 사회복지사가 실제 사례로 사용 후 피드백(가명화 확인).
- 상담 1건 소요 **약 60분 → 약 1분**(자기보고), 만족도 **5/5**, 업무 부담 **"훨씬 줄었다"(5/5)**, AI 정확도 **5/5**, 계속 사용 의향 **"예"**.
- 정성 후기: *"자료취합을 한눈에 볼 수 있게 정리됨", "추천하고 싶음."*
- ⚠️ *표본 1건으로 일반화는 이르며, 소요시간은 자기보고 값입니다 — feedback.html로 추가 수집 중.*
